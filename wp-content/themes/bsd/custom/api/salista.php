...
function format_salista( $salista ): array {
	return [
		...
		'banner'                   => get_field( 'banner', $salista->ID ) ? [
			...
			'medium_large' => get_field( 'banner', $salista->ID )['sizes']['medium_large'],
			'large'        => get_field( 'banner', $salista->ID )['sizes']['large'],
			'largest'      => get_field( 'banner', $salista->ID )['sizes']['1536x1536'],
			'full'         => get_field( 'banner', $salista->ID )['sizes']['2048x2048'],
			'original'     => get_field( 'banner', $salista->ID )['url'],
		] : null,
